...
namespace SCNeagtovo.DataModels.Migrations
{
    ...
    [Migration("20240913090141_MakeClientNullable2")]
    partial class MakeClientNullable2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCNeagtovo.DataModels.Models.DeliveryDetail", b =>
                {
                    ...
                    b.HasOne("SCNeagtovo.DataModels.Models.Order", "Order")
                        .WithOne("Delivery")
                        .HasForeignKey("SCNeagtovo.DataModels.Models.DeliveryDetail", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SCNeagtovo.DataModels.Models.Order", b =>
                {
                    b.HasOne("SCNeagtovo.DataModels.Models.Client", null)
                        .WithMany("Orders")
                        .HasForeignKey("ClientId");
                });
